...
export declare type CriterionModifier = components['schemas']['CriterionModifier'];

export declare type CustomFieldType = "text" | "longText" | "number" | "boolean" | "date" | "timestamp" | "duration" | "percent" | "url" | "enum" | "tag" | "performer" | "studio" | "video" | "gallery" | "image" | "group";
...
export declare interface DetailPageProps {
    id: number;
    onNavigate: (route: NavigateTarget) => void;
}

declare type EntityKind = (typeof EntityKinds)[keyof typeof EntityKinds];
export { EntityKind }
export { EntityKind as EntityType }

export declare const EntityKinds: {
...
export declare interface EntityTabProps {
    entityId: number;
}

export declare type EventKind = (typeof EventKinds)[keyof typeof EventKinds];
...
declare type ExtensionAction = components['schemas']['ExtensionAction'];
 ...
 */
export declare type ExtensionActionHandler = (action: ExtensionAction, payload: Record<string, unknown>) => Promise<unknown> | unknown;

export declare type ExtensionActionKind = (typeof ExtensionActionKinds)[keyof typeof ExtensionActionKinds];

export declare const ExtensionActionKinds: {
    readonly Bulk: "bulk";
...
export declare type FindFilter = components['schemas']['FindFilter'];
...
export declare type JobInfo = components['schemas']['JobInfo'];

export declare type JobStatus = components['schemas']['JobStatus'];
 ...
 */
export declare type ListCriterionType = "string" | "number" | "date" | "timestamp" | "duration" | "rating" | "multiId" | "enum" | "bool";

export declare type ListFilterContribution = components['schemas']['UIListFilterContribution'];

export declare type ListFilterOption = components['schemas']['UIListFilterOption'];

export declare type ListSortContribution = components['schemas']['UIListSortContribution'];
 ...
 */
export declare interface NavigateTarget {
...
export declare interface SlotProps<TContext = Record<string, unknown>> {
    context: TContext;
}

export declare type UiComponentKey = (typeof UiComponentKeys)[keyof typeof UiComponentKeys];

export declare const UiComponentKeys: {
 ...
 */
export declare interface UIManifestListContributions {
    listFilters?: ListFilterContribution[];
    listSorts?: ListSortContribution[];
}

export declare type UiPageKey = (typeof UiPageKeys)[keyof typeof UiPageKeys];

export declare const UiPageKeys: {
    readonly Gallery: "gallery";
    readonly Group: "group";
    readonly Home: "home";
    readonly Image: "image";
...
export declare type UiSlotKey = (typeof UiSlotKeys)[keyof typeof UiSlotKeys];

export declare const UiSlotKeys: {
...
export declare type UiZoneKey = (typeof UiZoneKeys)[keyof typeof UiZoneKeys];

export declare const UiZoneKeys: {
...
export declare interface UseJobPollingOptions {
