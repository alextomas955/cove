...
namespace Cove.Data.Migrations
{
    ...
    [Migration("20260920132948_AddVideoFileSourceHealth")]
    partial class AddVideoFileSourceHealth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cove.Core.Entities.DuplicateSearch", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("ExcludePaths")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<string[]>("IncludePaths")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<string>("KeeperRulesJson")
                        .HasMaxLength(8000)
                    ...
                    b.Property<double>("MinimumDuration")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Cove.Core.Entities.DuplicateSearchGroup", b =>
                {
                    ...
                    b.Property<bool>("DeleteGenerated")
                        .HasColumnType("boolean");
                    ...
                    b.Property<long>("RemovedBytes")
                        .HasColumnType("bigint");

                    b.Property<int>("RemovedVideoCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Cove.Data.UnfilteredVideoPerformerLink", b =>
                {
                    b.Property<int>("PerformerId")
                        .HasColumnType("integer")
                    ...
                    b.ToView("video_performers", (string)null);
                });
            ...
            modelBuilder.Entity("Cove.Core.Entities.VideoFile", b =>
                {
                    ...
                    b.Property<DateTime?>("SourceUnreadableAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SourceUnreadableReason")
                        .HasColumnType("text");

                    b.Property<long?>("SourceUnreadableSize")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Cove.Core.Entities.DuplicateIgnoredPair", b =>
                {
                    b.HasOne("Cove.Core.Entities.Video", "HighVideo")
                        .WithMany()
                        .HasForeignKey("HighVideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cove.Core.Entities.Video", "LowVideo")
                        .WithMany()
                        .HasForeignKey("LowVideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cove.Core.Entities.Video", b =>
                {
                    ...
                    b.HasOne("Cove.Core.Entities.VideoFile", "PrimaryFile")
                        .WithMany()
