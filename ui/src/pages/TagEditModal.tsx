...
export function TagEditModal({ tag, open, onClose }: Props) {
  ...
  const handleSave = () => {
    ...
    mutation.mutate({
      ...
      tagGroupId: tagGroupId ?? undefined,
      minOccurrenceSec: minOccurrenceSec ?? undefined,
      minOccurrencePercent: clampOptionalPercent(minOccurrencePercent) ?? undefined,
      showAsSegment: playerBarMode === "default" ? undefined : playerBarMode === "always",
      segmentColorOverride: playerBarMode === "always" ? (segmentColorOverride.trim() || undefined) : undefined,
      segmentLaneOverride: playerBarMode === "always" ? (segmentLaneOverride ?? undefined) : undefined,
      aliases: aliasList,
